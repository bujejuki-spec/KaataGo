...
void main() {
  ...
  group('kepala surat invoice', () {
    test('logonya dipasang di samping tulisan KaataGo', () {
      expect(sumber, contains("rootBundle.load('assets/icon/kaata_icon.png')"));
    ...
    test('logonya di kiri, sebelum tulisannya', () {
      ...
      expect(blok.indexOf('pw.Image(logo'),
          lessThan(blok.indexOf("pw.Text('KaataGo'")));
    });
