...
import 'package:pos_app/providers/app_prefs_provider.dart';
...
void main() {
  ...
  group('tema gelap', () {
    test('warna merek dinaikkan terangnya, tidak dipakai apa adanya', () {
      ...
      expect(KaataTheme.brandOnDark, isNot(KaataTheme.brand));
    });
    ...
    test('latarnya bukan hitam murni', () {
      ...
      expect(KaataTheme.darkBackground, isNot(Colors.black));
    });

    test('tema gelap dan terang keduanya bisa dibangun', () {
      expect(KaataTheme.dark().brightness, Brightness.dark);
      expect(KaataTheme.light().brightness, Brightness.light);
    });
  });
}
