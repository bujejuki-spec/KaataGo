...
/// pelapor, satu untuk KaataGo Admin — berarti dua tempat yang harus
...
class SupportChatScreen extends StatefulWidget {
  ...
  /// Layar ini dibuka oleh KaataGo Admin, bukan oleh pelapornya.
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text(t?.subject ?? 'KaataGo Support',
                maxLines: 1,
        ...
        children: [
          ...
          Expanded(
            child: Text(
              switch (tiket.status) {
                SupportStatus.open =>
                  'Pengaduan sudah masuk. KaataGo Admin akan menanggapinya.',
                SupportStatus.onProgress => 'Sedang ditangani KaataGo Admin.',
              ...
              style: TextStyle(
                  fontSize: 11.5, color: KaataTheme.textOf(context)),
            ),
          ),
        ],
      ),
...
class _Gelembung extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final teks = milikSaya ? Colors.white : KaataTheme.textOf(context);
    ...
    return SafeArea(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
              top: BorderSide(color: KaataTheme.borderOf(context))),
        ),
        child: Column(
          children: [
            if (foto != null)
