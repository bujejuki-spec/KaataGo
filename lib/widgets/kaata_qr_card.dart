...
import '../theme.dart';
import 'kaata_logo.dart';

/// Kartu QR bergaya KaataGo: bidang ungu bergradasi, siku amber di
...
class KaataQrCard extends StatelessWidget {
  /// Isi kode QR-nya.
  final String data;
    ...
    return SizedBox(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: KaataTheme.brand.withOpacity(0.28),
              blurRadius: _s(30),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      KaataLogo(size: _s(22), showBadgeBackground: false),
                      SizedBox(width: _s(7)),
                      Text(
                        'KaataGo',
                        style: TextStyle(
