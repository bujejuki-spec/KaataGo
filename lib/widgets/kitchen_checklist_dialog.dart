        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.checklist_rtl, color: KaataTheme.brand),
                ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: (_allDone ? const Color(0xFF10B981) : KaataTheme.brand).withOpacity(0.09),
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: _allDone ? const Color(0xFF046C4E) : KaataTheme.brandDark,
                ),
              ),
            ),
