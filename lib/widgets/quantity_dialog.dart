...
class _QuantityDialogState extends State<QuantityDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final unitPrice = widget.product.price + priceDelta;
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        ...
        children: [
          ...
          Text(
            priceDelta == 0
                ? '${currency.format(widget.product.price)} / item • Stok: ${widget.product.stock}'
                : '${currency.format(unitPrice)} / item (dasar ${currency.format(widget.product.price)} + ${currency.format(priceDelta)}) • Stok: ${widget.product.stock}',
      ...
      actions: [
        ...
        FilledButton(
          onPressed: () => Navigator.of(context).pop(QuantityDialogResult(
            quantity: _quantity,
