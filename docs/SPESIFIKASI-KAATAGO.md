# KaataGo — Specification Document (FSD + TSD)
...
KaataGo adalah aplikasi kasir (POS) sekaligus self-order untuk rumah
...
|---|---|---|
| Super Admin | `super_admin` | Seluruh resto di KaataGo |
...
| F-QR-05 | Simpan ke galeri | Masuk album **KaataGo**; label tombol "Simpan ke Galeri" (satu) / "Download Semua (N)" |
...
| Berkas | Isi |
|---|---|
| `docs/gambar/logo-kaatago.png` | Lambang KaataGo 1.34.0 — monogram K berpanah |
| `docs/gambar/qr-meja-kartu.png` | Kartu QR Meja hasil render sebenarnya (bukan mockup) |

![Logo KaataGo](gambar/logo-kaatago.png)
